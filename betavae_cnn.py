...
class vae(object):
    ...
    def getGenerator(self):
		...
		proj_reshaped = tf.reshape(gen_proj, [self.batch_size, 6, 6, 32])
		...
		trans_conv_1 = tf.nn.conv2d_transpose(proj_reshaped, self.trans_conv_w_1, output_shape=[self.batch_size, 13, 13, 64], strides=[1, 2, 2, 1], padding='VALID') + self.trans_conv_b_1
